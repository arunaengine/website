...
import {modelsv2Status, v2DataClass, v2ResourceVariant,} from '~/composables/aruna_api_json';
...
<!--    <div class="flex flex-col basis-1/3 gap-y-3 border-aruna-text/50">-->
<!--      &lt;!&ndash; Name and ID display with links &ndash;&gt;-->
...
<!--        <h4>{{ entry.id }}</h4>-->
<!--      </NuxtLink>-->
<!--      &lt;!&ndash; END Name and ID display with links &ndash;&gt;-->

<!--      &lt;!&ndash; Badges &ndash;&gt;-->
<!--      <div class="flex flex-col md:flex-row mt-2 gap-x-2 gap-y-2">-->
<!--        &lt;!&ndash; DataClass Badge &ndash;&gt;-->
...
<!--        </Badge>-->
<!--        &lt;!&ndash; END DataClass &ndash;&gt;-->
<!--        &lt;!&ndash; Stats Badge &ndash;&gt;-->
...
<!--        </Badge>-->
<!--        &lt;!&ndash; END Stats Badge &ndash;&gt;-->
<!--      </div>-->
<!--      &lt;!&ndash; END Badges &ndash;&gt;-->
<!--    </div>-->
...
<!--      &lt;!&ndash; Basic Label Display &ndash;&gt;-->
