        ...
        <div>
          ...
          <div class="flex rounded-md shadow-sm">
            <input type="text"
                   ...
                   class="py-3 px-4 pe-11 block w-full border-e-0 border-aruna-text/50 shadow-sm rounded-s-md text-sm focus:z-10 focus:ring-1 focus:ring-aruna-highlight disabled:opacity-50 disabled:pointer-events-none bg-aruna-muted text-aruna-text"
