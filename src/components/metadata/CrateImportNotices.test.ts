...
const components = Object.fromEntries(
  'AlertTriangle Button ChevronRight Code2 Copy CreateGroupDialog Dialog DialogClose DialogContent DialogDescription DialogFooter DialogHeader DialogTitle DiscardDraftConfirm FileJson FileJson2 FileUp GroupSelect Input Notice Plus Select SubcratePickerDialog Switch Tabs TabsList TabsTrigger Textarea Upload'
