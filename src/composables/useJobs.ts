...
// Durable job monitoring (aruna feat/job-framework). Config-gated: with the
// default portal config (features: {}) this module is inert — every network
// path starts with a featureEnabled('jobs') guard (useTes pattern).
